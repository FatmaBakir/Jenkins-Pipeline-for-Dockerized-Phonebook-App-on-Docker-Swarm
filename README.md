...
|----phonebook-cfn-template.yml # To be delivered  (Cloudformation template)
|----Dockerfile                 # To be delivered
|----docker-compose.yml         # To be delivered 
|----init.sql                   # Given  (SQL statements to initialize db)
|----jenkins-cfn-template.yml   # Given  (Cloudformation template for Jenkins Server)
|----Jenkinsfile                # To be delivered 
|----app
